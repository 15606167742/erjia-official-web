<template>
	<div class="home">
		...
		<div class="hot-house">
			...
			<div class="houses">
				<div class="house" :key="hotHouse.id" v-for="hotHouse in hotHouseList">
		...
		<div class="accessory">
			<div class="row">
				<div class="left">
					...
					<div class="title2">以始终如一的卓越品质，<br />助力客户实现价值最大化</div>
				</div>
				<el-image class="right" :src="require('@/assets/img/home/building.png')" fit="contain"></el-image>
			</div>
			<div class="accessory-imgs">
				<el-image class="accessory-img" :src="accessoryImg" fit="cover" :key="index"
					v-for="(accessoryImg, index) in accessoryImgList"></el-image>
			</div>
		</div>
		<div class="profile">
			<div class="profile-content">
				...
				<div class="text">
					依托德实资本20多亿元管理资本的雄厚实力，尔家商业成功运作多个上市地产公司旗下商业地产项目，布局上海、苏州、无锡、常州、镇江、成都等多个城市，在运营及已签约项目累计100余万方。</div>
				<div class="text">
