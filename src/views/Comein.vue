<template>
	<div class="comein">
		...
		<div class="content1" v-if="activeTab === 1">
			...
			<div class="info">
				<el-image class="info-img" :src="companyInfo.img" fit="contain"></el-image>
				<div class="info-content">{{ companyInfo.content }}</div>
			</div>
			<div class="row1">
...
import { indexVideo, projectVideoList, activityVideoList } from '@/network/comein.js';
