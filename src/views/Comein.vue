		...
		<div class="content1" v-if="activeTab === 1">
			<div class="introduction">
				...
				<div class="introduction-content">
					...
					<div class="text1" v-html="introduction.text1"></div>
