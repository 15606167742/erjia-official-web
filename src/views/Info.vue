<template>
	<div class="cooperation">
		...
		<div class="content1-detail" v-if="activeTab === 1 && activeNews">
			...
			<div class="row">
				<div class="datetime">
					发布时间：{{activeNews.datetime}}
				</div>
				<div class="count">
					浏览次数：{{activeNews.count}}
				</div>
			</div>
			<div class="line"></div>
			<div class="content">
				<p>近日，绿地集团西南事业部总经理孙志文、绿地集团西南营销管理中心总经理戴咏春等人莅临上海尔家商业管理有限公司天空树雅寓营销中心、绿地观澜湾尔家雅寓（以下简称：尔家商业）进行考察交流。目的为双方就进一步盘活商办资产进行深度交流合作，同时探索商办资产开发商与尔家赋能的新模式。尔家商业总裁张二干、尔家商业成都城市公司总经理谈潭等人陪同接待。
				</p>
				...
				<p>在此次考察交流当中，尔家商业总裁张二干指出：“尔家商业之所以能成为行业效仿的标杆，离不开独特的商业运营模式
					”。在实现资产盘活的同时为产品赋能，不仅为商办类资产开发商解决租赁人口居住问题还能为其赋能吸引更多人潮，从而实现合作共赢！</p>
			...
			<div class="tree">
				<div class="box" :key="activity.id" v-for="activity in activityList">
					...
					<div class="text">
						...
						<div class="date">
							<el-image class="date-icon" :src="require('@/assets/img/info/date.png')" fit="contain">
							</el-image>
