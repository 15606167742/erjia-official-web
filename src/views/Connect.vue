<template>
	<div class="connect">
		...
		<div class="content1" v-if="activeTab === 1">
			...
			<div :key="job.id" v-for="job in jobList">
				<div class="row2" :class="{ active: activeJob === job.id }" @click="handleJobChange(job.id)">
					...
					<div class="icon">
						<el-image class="img"
							:src="activeJob === job.id ? require('@/assets/img/connect/arrow2.png') : require('@/assets/img/connect/arrow1.png')"
		...
		<div class="content2" v-else-if="activeTab === 2">
			<div class="form">
				<div class="form-item" :class="{'form-item-row': form.key=='content'}" :key="index"
